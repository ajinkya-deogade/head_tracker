...
[filename_bk, pathname_bk, ext_bk] = uigetfile('*.avi','Select the video file to extract frames.');
...
flag = 1;
iniFile = 1;
finalFile = total_number_of_frames;
cgTime = 1;
skip_frame = 0;
...
for file_number = iniFile:finalFile
    ...
    i0 = read(vid_reader,file_number);
    i00 = i0;
    i1 = ibg - i0;
    ...
    if ~isempty(area_head)
        ...
        if head_number == 0 | head_found == 0
            ...
            elseif num_object > 1
                ...
                if head_number > 1
                    ...
                    disp(sprintf('No Head Found in frame %d',file_number));
                end
            end
        end
        if tail_number == 0 | tail_found == 0
            ...
            elseif num_object > 1 & head_found == 0
                ...
                disp(sprintf('No Tail Found in frame %d',file_number));
            end
        end
    end
